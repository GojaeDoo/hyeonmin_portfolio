...
const projects: ProjectData[] = [
    {
        ...
        projectReflection: [
            ...
            {
                title: '마무리',
                content: `처음에는 막막하고 어려웠지만, 단계별로 하나씩 해결해나가면서 많은 것을 배울 수 있었습니다. 프론트엔드 개발자로서 다른 역할들을 경험해본 것은 정말 값진 경험이었고, 앞으로 팀 프로젝트에서 더 나은 소통과 협업을 할 수 있을 것 같습니다.<br/><strong>자세한 소감은 GitHub README에서 확인부탁드립니다!</strong>`
            }
        ]
    },
    {
        ...
        projectReflection: [
            ...
            {
                title: '마무리',
                content: '포트폴리오 웹사이트를 통해 기술적 역량을 시각화할 수 있었고, 사용자 중심의 디자인과 개발 경험을 쌓을 수 있었습니다. 앞으로 더 나은 사용자 경험을 제공하는 웹사이트를 만들어나가겠습니다.<br/><strong>자세한 소감은 GitHub README에서 확인부탁드립니다!</strong>'
            }
        ]
    }
];
